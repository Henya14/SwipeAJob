...
import hu.bme.aut.android.swipeajob.Adapters.FragmentPagerAdapter.JobSwiperFragmentPagerAdapter_jobprovider
...
class JobSwiperActivity_jobprovider : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pager.adapter = JobSwiperFragmentPagerAdapter_jobprovider(this)
