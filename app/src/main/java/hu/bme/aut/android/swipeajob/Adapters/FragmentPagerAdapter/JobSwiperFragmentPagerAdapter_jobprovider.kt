...
import hu.bme.aut.android.swipeajob.Fragments.JobSwiperActivityFragments.JobSwiperFragment_jobprovider
...
class JobSwiperFragmentPagerAdapter_jobprovider(fm: FragmentActivity) :  FragmentStateAdapter(fm)
{
    companion object{
    ...
    override fun createFragment(position: Int): Fragment = when(position) {
        0 -> JobSwiperFragment_jobprovider()
